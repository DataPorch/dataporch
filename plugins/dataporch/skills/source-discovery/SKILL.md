...
description: MCP-only DataPorch source discovery; refuse curl, psql, shell, or direct-database fallbacks when the runtime is unavailable. Use for configured-source, schema, table, column, or catalog requests.
---
